...
const Movies = () => {
  ...
  const getMovies = (pageNumber) => {
    setLoading(true);
    fetch(
      `https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=${pageNumber}&sort_by=${sort}&api_key=${API_KEY}`
    )
  ...
  const handlePageClick = (newPage) => {
    navigate(`/discover/movies/${encodeURIComponent(newPage)}`);
