...
const TopRatedTv = () => {
  ...
  const getPopular = (pageNumber) => {
    setLoading(true);
    fetch(`https://api.themoviedb.org/3/tv/top_rated?language=en-US&page=${pageNumber}&api_key=${API_KEY}`)
  ...
  const handlePageClick = (newPage) => {
    navigate(`/tvshows/top-rated/${encodeURIComponent(newPage)}`);
