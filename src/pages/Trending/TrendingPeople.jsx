...
const TrendingPeople = () => {
  ...
  return (
    <div className='w-full h-screen flex flex-col gap-10' >
        <div>
            <h1 className='text-3xl font-bold'>Trending People Today</h1>
            <button className='bg-[#33333A] px-3 py-1 rounded-3xl my-3' onClick={() => navigate('/trending/people/today/1')}>View More</button>
        </div>
