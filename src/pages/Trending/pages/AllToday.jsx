...
const AllToday = () => {
  ...
  const getTvs = (pageNumber) => {
    setLoading(true);
    fetch(`https://api.themoviedb.org/3/trending/all/day?language=en-US&page=${pageNumber}&api_key=${API_KEY}`)
  ...
  const handlePageClick = (newPage) => {
    navigate(`/trending/all-today/${encodeURIComponent(newPage)}`);
