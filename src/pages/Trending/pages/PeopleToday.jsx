...
const PeopleToday = () => {
  ...
  const getTvs = (pageNumber) => {
    setLoading(true);
    fetch(`https://api.themoviedb.org/3/trending/person/day?language=en-US&page=${pageNumber}&api_key=${API_KEY}`)
  ...
  const handlePageClick = (newPage) => {
    navigate(`/trending/people/today/${encodeURIComponent(newPage)}`);
