...
const MovieToday = () => {
  ...
  const getTvs = (pageNumber) => {
    setLoading(true);
    fetch(`https://api.themoviedb.org/3/trending/movie/day?language=en-US&page=${pageNumber}&api_key=${API_KEY}`)
  ...
  const handlePageClick = (newPage) => {
    navigate(`/trending/movie/today/${encodeURIComponent(newPage)}`);
